...
function LinkedInIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" height="26" viewBox="0 0 72 72">
...
const LINKS = [
    ...
    { href: "https://x.com/darksorceror_", label: "X (Twitter)", Icon: XIcon },
    {
        href: "https://www.linkedin.com/in/hao-yan-212921274/",
        label: "LinkedIn",
        Icon: LinkedInIcon,
    },
    { href: "mailto:haoyan160@gmail.com", label: "Email", Icon: GmailIcon },
];
